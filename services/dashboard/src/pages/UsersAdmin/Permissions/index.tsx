...
// import { Role } from '../../../graphql/autogenerated/schemas';
import { Permission } from '../../../graphql/autogenerated/schemas';
import {
  GetPermissionsDocument,
  CreatePermissionDocument,
  UpdatePermissionDocument,
  DeletePermissionDocument,
} from '@graphql/autogenerated/hooks';

//=============================================================================
//#region Table configuration

export const ENTITY_NAME = 'Permission';
...
const PermissionsPage: React.FC = () => {
  ...
  const { loading, createItem, updateItem, removeItem } = useEntity<Permission>({
    entityName: ENTITY_NAME,
    get: GetPermissionsDocument,
    create: CreatePermissionDocument,
    update: UpdatePermissionDocument,
    remove: DeletePermissionDocument,
    onChange: ({ items }) => {
      ...
      {loading ? (
        ...
        <>
          ...
          {state.isCreateUpdateModalOpen && (
            <ModalForm
              title={state.entity ? 'Update Permission' : 'Create Permission'}
