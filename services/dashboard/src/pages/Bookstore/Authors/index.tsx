...
import { Author } from '@gqlauto/schemas';
import { CreateAuthorMutationVariables, UpdateAuthorMutationVariables } from '@gqlauto/operations';
      ...
      {loading ? (
        ...
        <>
          ...
          {state.isCreateUpdateModalOpen && (
            <ModalForm<Author, CreateAuthorMutationVariables, UpdateAuthorMutationVariables>
